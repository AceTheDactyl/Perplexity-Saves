...
# Archetypal tier mapping (z-range to frequency tier)
ARCHETYPAL_TIERS: Final[Dict[str, Dict[str, Any]]] = {
    'Planet': {
        'z_range': (0.0, PHI_INV),
        'frequency': FREQ_PLANET,
        'characteristics': ['foundation', 'grounding', 'stability'],
    },
    'Garden': {
        'z_range': (PHI_INV, Z_CRITICAL),
        'frequency': FREQ_GARDEN,
        'characteristics': ['transformation', 'growth', 'transition'],
    },
    'Rose': {
        'z_range': (Z_CRITICAL, 1.0),
        'frequency': FREQ_ROSE,
        'characteristics': ['transcendence', 'illumination', 'unity'],
    },
}
