...
# ═══════════════════════════════════════════════════════════════════════════════
# CONVENIENCE EXPORTS (added by fix script)
# ═══════════════════════════════════════════════════════════════════════════════

def run_hit_it_full(initial_z: float = 0.800, output_base: str = None, verbose: bool = True):
    """
    Convenience wrapper for run_full_execution.
    
    Args:
        initial_z: Starting z-coordinate (default 0.800)
        output_base: Base output directory
        verbose: Whether to print progress
    
    Returns:
        dict with manifest, zip_path, output_dir, workflow_summary
    """
    return run_full_execution(output_base=output_base)


class HitItFullPipeline:
    """
    Class wrapper for the hit_it full pipeline execution.
    Provides object-oriented interface for the 33-module pipeline.
    """
    
    def __init__(self, initial_z: float = 0.800, output_base: str = None, verbose: bool = True):
    ...
    def execute_full_pipeline(self):
        ...
        self.result = run_full_execution(output_base=self.output_base)
        return self.result
